...
def upgrade():
    ...
    op.add_column("appointments", sa.Column("series_id", sa.Integer, sa.ForeignKey("recurring_series.id"), nullable=True))
    op.add_column("appointments", sa.Column("next_reminder_at", sa.DateTime, nullable=True))
