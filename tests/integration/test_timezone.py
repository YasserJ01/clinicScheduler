...
class TestTimezoneHandling:
    ...
    def test_book_with_naive_datetime(
        self, http_client, auth_headers, patient_id, seeded_doctor_id
    ):
    ...
    def test_book_with_invalid_timeslot(
        self, http_client, auth_headers, patient_id, seeded_doctor_id
    ):
        resp = http_client.post(
            "/api/v1/appointments",
    ...
    def test_book_with_empty_timeslot(
        self, http_client, auth_headers, patient_id, seeded_doctor_id
    ):
        resp = http_client.post(
            "/api/v1/appointments",
